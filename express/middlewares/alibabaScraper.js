        ...
        for (const container of productContainers) {
            try {
                const productData = {
                    ...
                    moq: await extractData(container, ".search-card-m-sale-features__item"),
                    rating: await extractData(container, ".search-card-e-review strong"),
                    image: await extractData(container, "a.search-card-e-slider__link img.search-card-e-slider__img", "src"),
